...
class BitcoinTransactionsApi(object):
    ...
    def get_transaction(self, id, **kwargs):  # noqa: E501
        """Fetch a single transaction by transaction id.  # noqa: E501
        ...
        :param async bool
        :param str id: The transaction hash for which details should be fetched. (required)
        :param list[str] include: Specify what should be included in the response.
    ...
    def get_transaction_input(self, id, index, **kwargs):  # noqa: E501
        """Fetch a single input for a single transaction.  # noqa: E501
        ...
        :param async bool
        :param str id: The hash of the transaction for which inputs should be listed. (required)
        :param int index: The 0-based index of the input in the inputs vector ('vin') to fetch. (required)
        :param list[str] include: Specify which information to include with transactions inputs.
    ...
    def get_transaction_output(self, id, index, **kwargs):  # noqa: E501
        """Fetch a single output for a single transaction.  # noqa: E501
        ...
        :param async bool
        :param str id: The transaction the output belongs to. (required)
        :param int index: The 0-based index into the transaction's output vector (vout). (required)
        :param list[str] include: Specify which information to include with the transaction output.
    ...
    def list_transactions(self, **kwargs):  # noqa: E501
        """List transactions matching a given criteria.  # noqa: E501
    ...
    def list_transactions_inputs(self, id, **kwargs):  # noqa: E501
        """List inputs for a single transaction.  # noqa: E501
    ...
    def list_transactions_outputs(self, id, **kwargs):  # noqa: E501
        """List outputs from a single transaction.  # noqa: E501
        ...
        :param async bool
        :param str id: The hash of the transaction for which outputs should be listed. (required)
        :param list[str] include: Specify which information to include with transactions output.
        :param int page_limit:
        :param str page_token:
    ...
    def search_transactions(self, search_request, **kwargs):  # noqa: E501
        """Search transactions matching a given criteria.  # noqa: E501
    ...
    def summarize_transactions(self, unit, **kwargs):  # noqa: E501
        """summarize_transactions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.summarize_transactions(unit, async=True)
        >>> result = thread.get()

        :param async bool
        :param str unit: unit (required)
        :param datetime max_time:
        :param datetime min_time:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.summarize_transactions_with_http_info(unit, **kwargs)  # noqa: E501
        else:
            (data) = self.summarize_transactions_with_http_info(unit, **kwargs)  # noqa: E501
            return data

    def summarize_transactions_with_http_info(self, unit, **kwargs):  # noqa: E501
        """summarize_transactions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.summarize_transactions_with_http_info(unit, async=True)
        >>> result = thread.get()
        ...
        all_params = ['unit', 'max_time', 'min_time']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method summarize_transactions" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('unit' not in params or
                params['unit'] is None):
            raise ValueError("Missing the required parameter `unit` when calling `summarize_transactions`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/bitcoin/transactions/summary/by/{unit}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='SummarizeTransactionsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
